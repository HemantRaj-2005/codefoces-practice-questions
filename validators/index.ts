...
// Admin & User Authentication Schema
...
export const signupSchema = z.object({
  ...
  username: z.string().min(3, "Username must be at least 3 characters").trim().regex(/^[a-zA-Z0-9_]+$/, "Username can only contain letters, numbers, and underscores"),
  email: z.string().email("Invalid email address"),
  password: z.string().min(6, "Password must be at least 6 characters"),
